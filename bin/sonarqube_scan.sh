...
sonar-scanner -Dsonar.projectKey=$REPO -Dsonar.sources=. -Dsonar.host.url=$SONARCUBE_URL -Dsonar.login=$SONARCUBE_TOKEN -Dsonar.python.coverage.reportPaths=coverage.xml | grep "ANALYSIS SUCCESSFUL"
