...
from .users.vincentmohiuddin.code.montrek.montrek.code_generation.tests.data.output.managers.company_managers import (
    CompanyTableManager,
)
from .users.vincentmohiuddin.code.montrek.montrek.code_generation.tests.data.output.pages.company_pages import (
    CompanyPage,
)
from .users.vincentmohiuddin.code.montrek.montrek.code_generation.tests.data.output.forms.company_forms import (
    CompanyCreateForm,
)
...
class CompanyListView(MontrekListView):
    manager_class = CompanyTableManager
    page_class = CompanyPage
    tab = "tab_company_list"
    title = "Company List"
