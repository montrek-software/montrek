...
class TestDataTableFilters(TestCase):
    ...
    def test__get_link(self):
        ...
        self.assertEqual(str(test_link), f'<td><a id="id__baseclasses_{test_obj.id}_details" href="/baseclasses/{test_obj.id}/details" title="hover_text"><span class="glyphicon glyphicon-icon"></span></a></td>')
        ...
        test_link = dtf._get_link(test_obj, table_element)
        self.assertEqual(str(test_link), f'<td><a id="id__baseclasses_{test_obj.id}_details" href="/baseclasses/{test_obj.id}/details" title="hover_text">icon</a></td>')
    ...
    def test_get_attribute(self):
        ...
        self.assertEqual(str(test_str), f'<td><a id="id__baseclasses_{test_obj.id}_details" href="/baseclasses/{test_obj.id}/details" title="hover_text"><span class="glyphicon glyphicon-icon"></span></a></td>')
