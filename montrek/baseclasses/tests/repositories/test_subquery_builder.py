...
from baseclasses.tests.factories.baseclass_factories import LinkTestMontrekTestLinkFactory
...
class TestLinkedSatelliteSubqueryBuilder(TestCase):
    def setUp(self):
        ...
        link_entry_2_2 = LinkTestMontrekTestLinkFactory(
            in_hub=link_entry_2_1.in_hub,
            state_date_start=self.reference_date
        )
    ...
    def test_get_subquery(self):
        ...
        query = bc_models.TestMontrekHub.objects.annotate(
            **{"test_id": subquery}
        )
