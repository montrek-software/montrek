...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="currency_static_satellites",
                        to="currency.currencyhub",
                    ),
                ),
            ],
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["hash_identifier"], name="currency_cu_hash_id_0fbb5a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="currencystaticsatellite",
            index=models.Index(
                fields=["hash_value"], name="currency_cu_hash_va_fa2f2e_idx"
            ),
        ),
    ]
