...
from credit_institution.repositories.credit_institution_model_queries import new_credit_institution
from credit_institution.repositories.credit_institution_model_queries import new_credit_institution_to_account
...
from credit_institution.repositories.credit_institution_model_queries import get_credit_institution_satellite_by_account_hub_id
...
class TestCreditInstitutionModelQueries(TestCase):
    def test_new_credit_instutition(self):
        ...
        self.assertEqual(credit_institution_sat_db.credit_institution_name, 'Test Credit Institution')
    ...
    def test_new_credit_institution_to_account_and_get(self):
        ...
        self.assertEqual(credit_institution_hub, credit_institution_sat_db.hub_entity)
        account_credit_institution_link_table = AccountCreditInstitutionLink.objects.last()
        self.assertEqual(account_credit_institution_link_table.from_hub, account_hub)
        self.assertEqual(account_credit_institution_link_table.to_hub, credit_institution_hub)
        ...
        self.assertEqual(
            get_credit_institution_satellite_by_account_hub_id(account_id=account_hub.id),
            credit_institution_sat_db
        )
        self.assertEqual(
            get_credit_institution_satellite_by_account_hub(account_hub_object=account_hub),
            credit_institution_sat_db
        )
