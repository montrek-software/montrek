...
def new_credit_institution(
    credit_institution_name: str,
...
def new_credit_institution_to_account(
    credit_institution_name: str, account_hub: baseclass_models.MontrekHubABC
) -> None:
    credit_institution_hub_object = (
        credit_institution_hub()
        .objects.prefetch_related("creditinstitutionstaticsatellite_set")
        .filter(
...
def get_credit_institution_satellite_by_account_hub_id(
    account_id: int,
...
def get_credit_institution_satellite_by_account_hub(
    account_hub_object,
) -> baseclass_models.MontrekSatelliteABC:
    credit_institution_hub = (
