...
class AccountRegressionTests(TestCase):
    test_csv_path = os.path.join(os.path.dirname(__file__), "managers/data/dkb_test.csv")
    @classmethod
    def setUpTestData(cls):
        ...
        cls.credit_institution = CreditInstitutionStaticSatelliteFactory.create(account_upload_method="dkb")
    ...
    def test_upload_dkb_transactions_and_change_transaction_category(self):
        ...
        creator = DbCreator(hub_entity_class = TransactionHub, satellite_classes=[TransactionSatellite])
