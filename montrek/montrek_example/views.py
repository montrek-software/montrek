...
from baseclasses.dataclasses.view_classes import ActionElement, UploadFileActionElement
...
class MontrekExampleA1UploadView(FileUploadRegistryView):
    ...
    @property
    def actions(self) -> tuple:
        action_upload_file = UploadFileActionElement(
...
class MontrekExampleHubAApiUploadView(views.MontrekListView):
    ...
    @property
    def actions(self) -> tuple:
        action_do_a2_upload = UploadFileActionElement(
